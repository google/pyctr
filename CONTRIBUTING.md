...
(e.g. `analysis/activity_test.py`). They help to a)
...
TODO(aqj) confirm this path and uncomment.
```shell
bazel test --config=opt --copt=-O3 --copt=-march=native \
  //pyctr/...
``` -->

from the root of the `pyctr` repository.

## Developer info

Contributions should follow the [Google Python style guide](https://google.github.io/styleguide/pyguide.html).
