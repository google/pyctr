...
def copy_clean(node, preserve_annos=None):
  ...
  Returns:
    ast.AST
  """
  return _CleanCopier(preserve_annos).copy(node)
...
# TODO(mdanatg): Once we have error tracing, we may be able to just go to SSA.
