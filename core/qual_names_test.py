...
class QNTest(test.TestCase):
  ...
  def test_equality(self):
    ...
    self.assertEqual(a_b.parent, a)
    self.assertEqual(a_b2.parent, a)

    self.assertEqual(a_b2, a_b)
    self.assertIsNot(a_b2, a_b)
    self.assertNotEqual(a_b2, a)
    a_sub_b = QN(a, subscript='b')
    a_sub_b2 = QN(a, subscript='b')
    self.assertEqual(a_sub_b, a_sub_b2)
    self.assertNotEqual(a_sub_b, a_b)
